...
class Task_status extends Security_Controller {
    ...
    private function _make_row($data) {
        ...
        if (!$data->key_name) {
            $delete = js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_task_status'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("task_status/delete"), "data-action" => "delete"));
        }
