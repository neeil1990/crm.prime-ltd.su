<li class="js-cookie-tab <?php echo ($active_tab == 'tasks_list') ? 'active' : ''; ?>" data-tab="tasks_list"><a href="<?php echo_uri('tasks/all_tasks/'); ?>"><?php echo app_lang("list"); ?></a></li>
<li class="js-cookie-tab <?php echo ($active_tab == 'tasks_kanban') ? 'active' : ''; ?>" data-tab="tasks_kanban"><a href="<?php echo_uri('tasks/all_tasks_kanban/'); ?>" ><?php echo app_lang('kanban'); ?></a></li>
    <?php if (get_setting("module_gantt") && !$has_all_projects_restricted_role) { ?>
    <li class="<?php echo ($active_tab == 'gantt') ? 'active' : ''; ?>" ><a href="<?php echo_uri('tasks/all_gantt/'); ?>" ><?php echo app_lang('gantt'); ?></a></li>
<?php } ?>
