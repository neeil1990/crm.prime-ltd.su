...
class Pin_ticket_comments extends Crud_model {

    protected $table = null;

    function __construct() {
        $this->table = 'pin_ticket_comments';
        parent::__construct($this->table);
    }

    function get_details($options = array()) {
        $pin_comments_table = $this->db->prefixTable('pin_ticket_comments');
        $users_table = $this->db->prefixTable('users');
        $project_comments_table = $this->db->prefixTable('ticket_comments');
        ...
        $task_id = $this->_get_clean_value($options, "ticket_id");
        if ($task_id) {
            $where .= " AND $project_comments_table.ticket_id=$task_id";
        }
        ...
        LEFT JOIN $project_comments_table ON $project_comments_table.id= $pin_comments_table.ticket_comment_id
