...
class Telegram_Notification_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->product = "Telegram_Notification";
    ...
    function index() {
        ...
        echo $this->template->view("Telegram_Notification\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_telegram_notification_setting("telegram_notification_item_purchase_code");
