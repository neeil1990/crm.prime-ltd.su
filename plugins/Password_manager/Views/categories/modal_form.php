<?php echo form_open(get_uri("password_manager/save_category"), array("id" => "password-manager-category-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#password-manager-category-form").appForm({
            onSuccess: function (result) {
                $("#password-manager-category-table").appTable({newData: result.data, dataId: result.id});
            }
        });
    });
</script>