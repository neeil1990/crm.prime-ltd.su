...
class Password_manager_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->app_update_url = "https://releases.thesketchcode.com/rise_plugins/";
        $this->product = "Password_manager";
    ...
    function index() {
        ...
        echo $this->template->view("Password_manager\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_setting("password_manager_item_purchase_code");
